...
DIFFICULTY1 = int(input("Enter difficulty for PLAYER1: "))
DIFFICULTY2 = int(input("Enter difficulty for PLAYER2: "))
...
def main():
    ...
    global COMPUTERWINNERIMG, WINNERRECT, TIEWINNERIMG, BLACKWINS, REDWINS
...
def runGame(isFirstGame):
    ...
    while True: # main game loop
        if turn == HUMAN:
            ...
            column = getComputerMove(mainBoard, DIFFICULTY2)
            animateComputerMoving(mainBoard, column)
